...
const MainMenu = ({
  ...
  return (
    <Fragment>
      <PanelSectionRow>Undervolt Status: {status}</PanelSectionRow>
        ...
        <Fragment>
          <PanelSectionRow>
            <ToggleField
              ...
              description={`Checking this will apply the undervolt after some time when ${state.runningAppName ? state.runningAppName : "specific game"} is opened. Might be useful for games with launchers.`}
            />
          </PanelSectionRow>
          {usePresetTimeout && (
            <PanelSectionRow>
